...
public class WarehouseZoneRepository(AppDbContext context) : BaseRepository<WarehouseZone, int>(context), IWarehouseZoneRepository
{
    public async Task<IEnumerable<WarehouseZone>> FindByWarehouseIdAsync(WarehouseId warehouseId,
